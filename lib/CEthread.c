...
#ifndef PROJECT2_LIB_CEthread_C
#define PROJECT2_LIB_CEthread_C
                    ...
                    void* args)
{
    ...
    CEthreads_arguments_t* clone_args = allocate_mem(sizeof(CEthreads_arguments_t));
...
{
    CEthreads_arguments_t* clone_args = (CEthreads_arguments_t*) args;
